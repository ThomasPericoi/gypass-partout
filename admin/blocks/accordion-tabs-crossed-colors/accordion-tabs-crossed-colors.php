...
/**
 * Accordion Tabs Crossed (Colors) Template.
 *
...
<!-- Block - Accordion Tabs (Crossed / Colors) -->
            ...
            <div class="content formatted">
                ...
                <?php if (have_rows('options')) : ?>
                    <div class="options-wrapper">
                        ...
                        <nav class="options options-<?php echo $options_count; ?>">
                                ...
                                <div class="accordion-list">
                                    <?php if (have_rows('elements')) :
                                        while (have_rows('elements')) : the_row();
                                            ...
                                            $color = get_sub_field('color');
                                            $color_label = get_sub_field('color_label'); ?>
                                            <button class="<?php echo $color_label; ?>" style="background: <?php echo $color; ?>;" data-tab-target="<?php echo $tab_index; ?>" data-element-target="<?php echo $element_index; ?>"><?php echo $label; ?></button>
                                    <?php endwhile;
                                    endif; ?>
                                </div>
                            </div>
