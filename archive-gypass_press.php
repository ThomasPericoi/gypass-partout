...
<?php if (is_tax()):
    ...
    $description = get_queried_object()->description ?: __("Retrouvez ici tous les documents presse GYPASS.", "gypass");
else:
    $title = get_field('press_documents_title', 'options') ?: __("Espace presse", "gypass");
    $description = get_field('press_documents_description', 'options') ?: __("Retrouvez ici tous les documents presse GYPASS.", "gypass");
endif;
?>
...
<section id="press">
    <div class="container container-lg">
        ...
        <?php else:
            echo __('Aucun document presse n\'a (encore) été publié.', 'gypass');
        endif; ?>
    </div>
</section>

<?php if (get_field('press_documents_cta_banner', 'options') == "true"): ?>
    <?php get_template_part('template-parts/cta-banner', '', array(
        'title' => get_field('press_documents_cta_banner_title', 'options'),
        'description' => get_field('press_documents_cta_banner_description', 'options'),
        'cta' => get_field('press_documents_cta_banner_cta', 'options'),
